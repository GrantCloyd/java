...
//        System.out.println(bankAccountOne.withDrawFundsFromAtm(20.00));
        BankAccount bankAccountTwo = new BankAccount("123456789234", 350.00, "Donny P", "atax@net.com", "2404458956");
        System.out.println(bankAccountTwo.getBalance());
        System.out.println(bankAccountTwo.getAccountNumber());
        System.out.println(bankAccountTwo.getCustomerName());
    }
}
